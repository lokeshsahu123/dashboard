                ...
                <div class="container-fluid">
                    <div class="bank-details row d-flex align-items-baseline">
                        <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                            <h1 class="title_h1 same_heading">Quick Turnover 2.0</h1>
                        </div>
                        <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4  col-sm-6 mt-lg-0  mt-md-4 mt-2 col-xs-12 p-1">
                                    <div class="form-group">
                                        <select name="" id="" class="w-100">
                                            <option value="" selected="">All Games</option>
                                            <option value="">Single chance Dark Theme</option>
                                            <option value="">Single chance Dark Theme PC</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4  col-sm-6 mt-lg-0  mt-md-4 mt-2 col-xs-12 p-1">
                                    <div class="form-group">
                                        <select name="" id="" class="w-100">
                                            <option value="" selected="">Claim Point</option>
                                            <option value="">Win Point</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4  col-sm-6 mt-lg-0  mt-md-4 mt-2 col-xs-12 p-1">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 px-1 px-lg-2">
                    ...
                    <table class="table data-table">
                        <thead>
                            <tr>
                                ...
                                <th>NTP <i class="fa-sharp fa-solid fa-circle-question"></i></th>
                                <th>NTP % <i class="fa-sharp fa-solid fa-circle-question"></i></th>
                            </tr>
                        </thead>
                        <tbody>
