                ...
                <div class="container-fluid">
                    <div class="bank-details row d-flex align-items-baseline">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <h1 class="title_h1 same_heading">Account statement</h1>
                        </div>
                        <div class="col-lg-9 col-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-6 mt-2 mt-lg-0 mt-md-0">
                                    <div class="form-group">
                                        <select name="" id="" class="w-100">
                        ...
                        <!-- <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 px-1 px-lg-2">
                            <div class="row">
                                <div class="col-lg-3 col-6 d-flex align-items-start accountHBcheckbox">
                                    <label for="">Include bot</label>
                                    <input type="checkbox">
                                </div>
