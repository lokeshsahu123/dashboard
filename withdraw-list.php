                ...
                <div class="container-fluid">
                    <div class="bank-details row">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <h1 class="title_h1 same_heading">Withdraw Transactions</h1>
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6  col-sm-6 mt-lg-0  mt-md-4 mt-1 col-xs-12 p-1">
                        ...
                        <div class="col-2"></div>
                        <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 px-1 px-lg-2 mt-lg-0  mt-md-0 mt-1 ">
