                ...
                <div class="container-fluid">
                    <div class="bank-details row d-flex align-items-baseline">
                        <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
                            <h1 class="title_h1 same_heading">Player Turnover</h1>
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="col-lg-6 col-md-12  col-sm-12  col-xs-12  p-1">
                                ...
                                <div class="col-lg-6 col-md-6  col-sm-6 mt-lg-0  mt-md-4 mt-2 col-xs-12 p-1">
                                    <div class="form-group">
                                        <select name="" id="" class="w-100">
                        ...
                        <div class="col-12 text-end">
                            <a href="#" id="excel"><button class="btn  btn-secondary btn-sm "><i
